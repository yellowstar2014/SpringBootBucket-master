...
public class NotifyController {
    ...
    public BaseResponse unbind(@ApiParam(value = "IMEI码") @RequestParam("imei") String imei) {
        _logger.info(imei+"解绑通知接口start");
...
//                               @ApiParam(value = "IMEI码") @RequestParam("imei") String imei) {
//        _logger.info(imei+"解绑通知接口start");
//        return new BaseResponse<>(true, "解绑通知发送成功", null);
//    }
